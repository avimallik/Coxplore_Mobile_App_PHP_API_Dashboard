...
if(isset($_GET['id'])) {
    $id_temp = $_GET['id'];
    $result = mysqli_query($db,"SELECT * FROM shopping where id=" . $id_temp);
    echo "<table>";
    while($row = mysqli_fetch_array($result)) 
    { 
       $id = $row["id"];

       $shopping_details = $row["shopping_details"];
       //Image One
       $image = $row["image_one"];
...
<div class="container" >
  <div class="row" style = "height : 550px;">
    ...
    <form method="POST" action="shopping_update_manipule.php" enctype="multipart/form-data">
    ...
    <div class="form-group has-success">
        <label class="col-xs-2 control-label" for="inputSuccess">Shopping Details</label>
        <div class="col-md-12">
        <textarea id="myeditor" name="shopping_details" id="myeditor"><?php echo $shopping_details;?></textarea>
        </div>
    </div>
...
<div class="col-sm-6" style="border : 1px solid #969696">
<form method="POST" action="shopping_update_image_manipule.php" enctype="multipart/form-data">
<div class = "container">
<div class = "row">


    <div class="col-md-4">
   <img src = "<?php echo $image_path;?>" style = "height:100px; width:100px;">
    </div>
    
     <div class="col-md-4">
    <img src = "<?php echo $image_two_path;?>" style = "height:100px; width:100px;">
    </div>
    
    <div class="col-md-4">
    <img src = "<?php echo $image_three_path;?>" style = "height:100px; width:100px;">
    </div>
    ...
    <div class="col-md-1">
    <input type="text" name = "image_three_path" value = "<?php echo $image_three_path;?>" style = "visibility: hidden;" style = "visibility: hidden;" readonly>
    </div>
