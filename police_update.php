...
if(isset($_GET['id'])) {
    $id_temp = $_GET['id'];
    $result = mysqli_query($db,"SELECT * FROM police where id=" . $id_temp);
    echo "<table>";
    ...
    { 
       ...
       $police_details = $row["police_details"];
       $phone = $row["phone"];
...
<div id="content">
  ...
  <form method="POST" action="police_update_manipule.php" enctype="multipart/form-data">
   ...
   <input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-xs-10">
            <input type="text" id="inputSuccess" class="form-control" placeholder="Type Police Name" name="police_name"  value = "<?php echo $police_name;?>" >
        </div>
    </div>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-md-12">
        <textarea id="myeditor" name="police_details" id="myeditor"><?php echo $police_details;?></textarea>
        </div>
    </div>
...
<center>
    <div>
      <button type="submit" class="btn btn-primary" style = "width:80%" onclick="window.location.href='police_list.php'">Police List</button>
  	</div>
</center>
...
<form method="POST" action="police_update_image_manipule.php" enctype="multipart/form-data">
<input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly >
