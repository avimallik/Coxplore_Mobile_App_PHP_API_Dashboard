...
//   $image_text = $_POST["image_text"];
  ...
  $image_url =  "http://www.coxplorebd.com/uploaded_transport_bus_image/".$image_store;
  $target = "uploaded_transport_bus_image/".basename($image_store);

  $sql = "UPDATE transport_bus SET image = '$image_store',image_path = '$image_url' WHERE id=$id";
