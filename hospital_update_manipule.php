...
if(isset($_POST['update'])){
  ...
  $hospital_details = html_entity_decode($_POST['hospital_details']);
  $phone = $_POST['phone'];
...
//   $image_text = $_POST["image_text"];
  ...
  $sql = "UPDATE hospital SET hospital_name = '$hospital_name',hospital_details = '$hospital_details',phone = '$phone', latitude = '$latitude', longitude = '$longitude' WHERE id=$id";
