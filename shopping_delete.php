...
$result = mysqli_query($db,"SELECT * FROM shopping where id=" . $id);
...
{ 
  ...
  $file = "uploaded_shopping_image/".$image;
  $file_two = "uploaded_shopping_image/".$image_two;
  $file_three = "uploaded_shopping_image/".$image_three;
