...
<center>
    ...
    <input type="text" name = "image_name" value = "<?php echo $image;?>" readonly > 
    <input type="text" name = "image_path" value = "<?php echo $image_path;?>" readonly > 
    ...
    <img src="image/icon/details.png" style=" height: 50px ;width : 50px"><br>
