...
if(isset($_GET['id'])) {
    $id_temp= $_GET['id'];
    $result = mysqli_query($db,"SELECT * FROM food where id=" . $id_temp);
    echo "<table>";
    ...
    { 
       ...
       $restaurant_details = $row["restaurant_details"];
       $phone = $row["phone"];
...
<div id="content">
  ...
  <form method="POST" action="food_update_manipule.php" enctype="multipart/form-data">
   ...
   <input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-xs-10">
            <input type="text" id="inputSuccess" class="form-control" placeholder="Type Restaurant Name" name="restaurant_name"  value = "<?php echo $restaurant_name;?>" >
        </div>
    </div>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-md-12">
        <textarea id="myeditor" name="restaurant_details" id="myeditor"><?php echo $restaurant_details;?></textarea>
        </div>
    </div>
...
<center>
    <div>
      <button type="submit" class="btn btn-primary" style = "width:80%" onclick="window.location.href='food_list.php'">Restaurant List</button>
  	</div>
</center>
...
<form method="POST" action="food_update_image_manipule.php" enctype="multipart/form-data">
<input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly >
