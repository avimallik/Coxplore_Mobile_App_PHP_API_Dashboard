...
<div class="container">
<br>
<a href = "admin_insert.php"><button type="button" class="btn btn-primary btn-block">Add More Infomation</button></a>
</div>
<br>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" ."<br>". $row["admin_name"] . "</td>";
        // echo "<td>" ."<br>". $row["transport_website"] . "</td>";
        echo "<td>" ."<br>". $row["password"] . "</td>";
        // echo "<td>" ."<br>". $row["transport_details"] . "</td>";
        
        // echo "<td>" . "<a href = 'dataedit.php? id=".$row["id"]"'>"  . 'edit' .   "</a>"  .    "</td>"; 
        echo "<td>  

                <a href='admin_update.php?".$sum."' class='btn btn-success' role='button'><img src = 'image/icon/edit.png'/>More</a> <br><br>     
                <a href='admin_delete.php?".$sum."' class='btn btn-danger' role='button'><img src = 'image/icon/delete.png'/> Delete</a>
