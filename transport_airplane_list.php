...
<div class="container">
<br>
<a href = "transport_airplane_insert.php"><button type="button" class="btn btn-primary btn-block">Add More Information</button></a>
</div>
<br>
...
$sql = "SELECT * FROM transport_airplane";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>" . "<img src ="
        ."uploaded_transport_airplane_image/"
        .$row['image']." height = '100' width = '100'>". "</td>";
        // echo "<td>" . "<a href = 'dataedit.php? id=".$row["id"]"'>"  . 'edit' .   "</a>"  .    "</td>"; 
        echo "<td>  

                <a href='transport_airplane_update.php?".$sum."' class='btn btn-success' role='button'><img src = 'image/icon/edit.png'/>More</a> <br><br>     
                <a href='transport_airplane_delete.php?".$sum."' class='btn btn-danger' role='button'><img src = 'image/icon/delete.png'/> Delete</a>
