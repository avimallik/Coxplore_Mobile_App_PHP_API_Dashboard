...
if(isset($_GET['id'])) {
    $id_temp = $_GET['id'];
    $result = mysqli_query($db,"SELECT * FROM hospital where id=" . $id_temp);
    echo "<table>";
...
<div id="content">
  ...
  <form method="POST" action="hospital_update_manipule.php" enctype="multipart/form-data">
   ...
   <input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-xs-10">
            <input type="text" id="inputSuccess" class="form-control" placeholder="Type Hospital Name" name="hospital_name"  value = "<?php echo $hospital_name;?>" >
        </div>
    </div>
    ...
    <div class="form-group has-success">
        ...
        <div class="col-md-12">
        <textarea id="myeditor" name="hospital_details" id="myeditor"><?php echo $hospital_details;?></textarea>
        </div>
    </div>
...
<center>
    <div>
      <button type="submit" class="btn btn-primary" style = "width:80%" onclick="window.location.href='hospital_list.php'">Hospital List</button>
  	</div>
</center>
...
<form method="POST" action="hospital_update_image_manipule.php" enctype="multipart/form-data">
<input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly >
