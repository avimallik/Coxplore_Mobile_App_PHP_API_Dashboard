...
if(isset($_GET['id'])) {
    $id_temp= $_GET['id'];
    $result = mysqli_query($db,"SELECT * FROM transport_airplane where id=" . $id_temp);
    echo "<table>";
...
<div id="content">
  ...
  <form method="POST" action="transport_airplane_update_manipule.php" enctype="multipart/form-data">
...
<center>
    <div>
      <button type="submit" class="btn btn-primary" style = "width:80%" onclick="window.location.href='transport_airplane_list.php'">Air Transport List</button>
  	</div>
</center>
...
<form method="POST" action="transport_airplane_update_image_manipule.php" enctype="multipart/form-data">
<input type="text" name = "id" value = "<?php echo $id; ?>" style = "visibility: hidden;" readonly >
