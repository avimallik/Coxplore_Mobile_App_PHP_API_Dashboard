...
if(isset($_POST['update'])){
  ...
  $tourist_agent_name = $_POST["tourist_agent_name"];
  $tourist_agent_details = html_entity_decode($_POST['tourist_agent_details']);
  $phone = $_POST['phone'];
...
//   $image_text = $_POST["image_text"];
  ...
  $sql = "UPDATE tourist_agent SET tourist_agent_name = '$tourist_agent_name',tourist_agent_details = '$tourist_agent_details',phone = '$phone', latitude = '$latitude', longitude = '$longitude' WHERE id=$id";
