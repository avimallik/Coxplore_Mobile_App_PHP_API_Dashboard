...
if(isset($_POST['update'])){
  ...
  $atm_name = $_POST["hospital_name"];
  $atm_details = html_entity_decode($_POST['hospital_details']);
  $phone = $_POST['phone'];
...
//   $image_text = $_POST["image_text"];
  ...
  $sql = "UPDATE atm SET atm_name = '$atm_name',atm_details = '$atm_details',phone = '$phone', latitude = '$latitude', longitude = '$longitude' WHERE id=$id";
