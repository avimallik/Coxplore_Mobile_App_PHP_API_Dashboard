...
//   $image_text = $_POST["image_text"];
  ...
  $sql = "UPDATE transport_airplane SET transport_name = '$transport_name',transport_details = '$transport_details', transport_phone = '$transport_phone', transport_website = '$transport_website' WHERE id=$id";
