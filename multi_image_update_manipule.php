...
if(isset($_POST['update'])){
  ...
  $image_one_name = $_POST["image_one_name"];
  $image_two_name = $_POST["image_two_name"];
  $image_three_name = $_POST["image_three_name"];
...
//   $image_text = $_POST["image_text"];
  ...
  $sql = "UPDATE multi_image SET image_one_name = '$image_one_name',image_two_name = '$image_two_name',image_three_name = '$image_three_name' WHERE id=$id";
